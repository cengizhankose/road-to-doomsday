...
CREATE TABLE "title_progress" (
	...
	"member_one_score" smallint,
	"member_two_score" smallint,
	...
	CONSTRAINT "title_progress_member_one_score_check" CHECK ("title_progress"."member_one_score" is null or "title_progress"."member_one_score" between 0 and 10),
	CONSTRAINT "title_progress_member_two_score_check" CHECK ("title_progress"."member_two_score" is null or "title_progress"."member_two_score" between 0 and 10),
